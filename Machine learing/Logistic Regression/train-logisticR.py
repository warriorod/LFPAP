...
def LR_train_model(data_set):
    ...
    model = LogisticRegression(penalty = 'l1', C= 5, class_weight='balanced',solver='liblinear',random_state=42)
    model.fit(X,y)
